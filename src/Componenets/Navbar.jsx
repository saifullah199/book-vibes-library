...
const Navbar = () => {
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal flex items-center gap-7 text-xl px-1">
  ...
  <div className="navbar-end  ">
    <a className="btn btn-outline btn-primary mr-3 text-white ">Sign In </a>
    <a className="btn btn-outline btn-accent text-white">Sign Up </a>
  </div>
</div>
        </div>
    );
